 ...
 <div class="overflow-visible bg-gradient-to-r from-gray-100 to-gray-200"  data-scroll-container>
   <Header class="z-20 transition duration-700 ease-in-out transform hover:translate-y-1 motion-reduce:transition-none motion-reduce:transform-none" />
    ...
    <main class="overflow-hidden">
        ...
        <!-- Contact section -->
        <section class="relative bg-gradient-to-r from-gray-100 to-gray-200" aria-labelledby="contact-heading">
        <div class="absolute w-full h-1/2 bg-warm-gray-50" aria-hidden="true"></div>
        
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative bg-gradient-to-r from-gray-100 to-gray-200 shadow-xl">
            <h2 id="contact-heading" class="sr-only">Contact us</h2>

            <div class="grid grid-cols-1 lg:grid-cols-3">
                <!-- Contact information -->
                <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-indigo-500 to-cyan-600 sm:px-10 xl:p-12">
                ...
                <h3 class="font-heading-font text-lg font-medium text-white">Contact information</h3>
                <p class="font-primary-font mt-6 text-base text-cyan-50 max-w-3xl">
                    While we're good with smoke signals, there are simpler ways to get in touch and answer your questions
                </p>
                <dl class="mt-8 space-y-6">
                    ...
                    <span class="ml-3 font-heading-font">+254 716 202 298</span>
                    </dd>
                    ...
                    <span class="ml-3 font-heading-font">support@angol.com</span>
                    </dd>
                </dl>
                <ul role="list" class="mt-8 flex space-x-12">
                    <li>
                    <a class="text-cyan-200 hover:text-cyan-100" href="#">
                ...
                <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div class="mt-1">
                        <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border-warm-gray-300 rounded-md">
                    </div>
                    </div>
                    <div>
                    <label for="last-name" class="block text-sm font-medium text-warm-gray-900">Last name</label>
                    <div class="mt-1">
                        <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border-warm-gray-300 rounded-md">
                    </div>
                    </div>
                    <div>
                    <label for="email" class="block text-sm font-medium text-warm-gray-900">Email</label>
                    <div class="mt-1">
                        <input id="email" name="email" type="email" autocomplete="email" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border-warm-gray-300 rounded-md">
                    </div>
                    </div>
                    <div>
                    ...
                    <div class="mt-1">
                        <input type="text" name="phone" id="phone" autocomplete="tel" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border-warm-gray-300 rounded-md" aria-describedby="phone-optional">
                    </div>
                    </div>
                    <div class="sm:col-span-2">
                    <label for="subject" class="block text-sm font-medium text-warm-gray-900">Subject</label>
                    <div class="mt-1">
                        <input type="text" name="subject" id="subject" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border-warm-gray-300 rounded-md">
                    </div>
                    </div>
                    <div class="sm:col-span-2">
                    <div class="flex justify-between">
                    ...
                    <div class="mt-1">
                        <textarea id="message" name="message" rows="4" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-cyan-500 focus:border-cyan-500 border border-warm-gray-300 rounded-md" aria-describedby="message-max"></textarea>
                    </div>
                    </div>
    ...
    <footer id="foota" class="font-primary-font pb-2 bg-gradient-to-r from-gray-100 to-gray-200" aria-labelledby="footer-heading">
      ...
      <div class="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div data-scroll data-scroll-speed="1" class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
        ...
        <div  class="mt-8 border-t border-gray-200 py-8 flex justify-between">
          ...
          <p class="text-base text-gray-400 xl:text-center">
            Developer - michaelsaiba84@gmail.com
          </p>
        </div>
      </div>
    </footer>
