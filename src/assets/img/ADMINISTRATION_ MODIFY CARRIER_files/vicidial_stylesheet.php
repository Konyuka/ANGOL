...
.std_row1 {background-color: 9BB9FB}
.std_row2 {background-color: B9CBFD}
.std_row3 {background-color: 8EBCFD}
.std_row4 {background-color: B6D3FC}
.std_row5 {background-color: FFFFFF}
.alt_row1 {background-color: BDFFBD}
.alt_row2 {background-color: 99FF99}
.alt_row3 {background-color: CCFFCC}
.std_btn  {background-color: ;}


.border2px {border:solid 2px #015B91}
